...
function Faqs() {
  ...
  const faqs = [
    {
      ...
      answer:
        'Competitive Manpower International Limited is a Kenyan based company that provides manpower services.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Competitive Manpower International Limited was founded to meet the demand for manpower and address the high number of unemployed youth in Kenya.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Competitive Manpower International Limited has a close-knit organized team consisting of dynamic and talented achievers with professional backgrounds in administrative and human resources.',
    },
    {
      question: '6. What kind of services does Competitive Manpower International Limited provide?',
      answer:
        'Competitive Manpower International Limited is a multiple service provider with professionals from various industries, and is built on over 5 years of experience in management and recruitment. The company provides quality services and solutions in manpower, among other services.',
    },
    {
  ...
  return (
    <div className="p-6 " style={{ maxWidth: '1000px', margin: 'auto' }}>
      <h2 className="text-xl font-bold text-orange-500 mb-4 text-center">Frequently Asked Questions</h2>
      {faqs.map((faq, index) => (
        <div key={index} className="border-b pb-6 mb-6 cursor-pointer" onClick={() => toggleActive(index)}>
